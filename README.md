...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/606595fccb81e00017891201
...
To start editing your site, you can use the Sanity interface at https://stefano-bullo-595fc.sanity.studio/.
...
Generated at `2021-04-01T09:49:44.090Z` by Stackbit version `0.3.50`.